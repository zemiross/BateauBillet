...
export const supportCategories: SupportCategory[] = [
  ...
  },
  {
    ...
    articleSlugs: [
      ...
      "barcelona-zona-bajas-emisiones",
      "antelacion-sin-vehicule",
      "taquillas-antes-embarque",
      "rutas-horarios-barcelona-baleares",
      "rutas-horarios-valencia-baleares",
      "rutas-horarios-denia-baleares",
      "rutas-horarios-tanger-med",
      "rutas-horarios-melilla-peninsula",
      "rutas-horarios-almeria-nador",
      "rutas-horarios-huelva-canarias",
      "rutas-horarios-interinsulares",
    ],
  },
  {
    id: "acomodaciones",
...
const articleContentLength: Partial<Record<string, number>> = {
  ...
  "parking-valencia": 4,
  "parking-denia": 6,
  "parking-ibiza-botafoc": 1,
  "embarcar-port-barcelona": 4,
  "barcelona-zona-bajas-emisiones": 3,
  "antelacion-sin-vehicule": 4,
  "taquillas-antes-embarque": 1,
  "rutas-horarios-barcelona-baleares": 3,
  "rutas-horarios-valencia-baleares": 3,
  "rutas-horarios-denia-baleares": 3,
  "rutas-horarios-tanger-med": 4,
"rutas-horarios-melilla-peninsula": 1,
    "rutas-horarios-almeria-nador": 1,
    "rutas-horarios-huelva-canarias": 1,
    "rutas-horarios-interinsulares": 1,
};
